<?php
  ...
  {
    $query = "INSERT INTO `registration_fee`(`registration_code`, `church`, `paid_date`, `amount`, `fullname`, `contact`) VALUES ('".$_POST["paymentApproved"]."', '".$_POST["church"]."', CURRENT_DATE(), '".$_POST["amount"]."', '".$_POST["fullname"]."', '".$_POST["contact"]."')";
